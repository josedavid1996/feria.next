...
const AuspiciadorD = (props) => {
  ...
  const { modalTitulo, volver, tituloPatrocinador } = props.AuspiciadorD
      ...
      <div className="standBack ">
        <PagineTemplate idioma={props} retornar>
          ...
          >
            ...
            <Link href="auspiciador-d/pis">
              <a className="hover:scale-105 transition-transform duration-500">
                <Image
                  className="cursor-pointer "
                  src="/image/auspiciadorD/pis.png"
                  alt="pis"
                  width="150px"
                  height="100px"
                />
            ...
            <Link href="auspiciador-d/diagro">
              <a className="hover:scale-105 transition-transform duration-500">
                <Image
                  className="cursor-pointer "
                  src="/image/auspiciadorD/diagro.png"
                  alt="diagro"
                  width="150px"
                  height="100px"
                />
...
export async function getStaticProps({ locale }) {
  ...
  return {
    props: {
      ...
      AuspiciadorD: response.default.AuspiciadorD
    }
  }
}
